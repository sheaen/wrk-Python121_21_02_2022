class Human:
    def __init__(self, age = 18, gender = 'None', height = 1.7):
        self.age = str(age)
...
if __name__ == '__main__':
    ...
    person2_b = Builder(age = 45, gender = 'male', height = 1.89)
    person2_b.favorite_tools = 'Шпатель'

    person3_s = Sailor()
    person3_s.ship = 'Линкор'

    person4_p = Pilot(age = 23,gender = 'female', height = 1.66, airship_type = 'Вертолёт', airship = 'Красный')
